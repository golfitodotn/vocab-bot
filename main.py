...
def get_chat_reply(text):
    try:
        response = gemini.generate_content(
            f"คุณชื่อประเทือง ให้แทนตัวเองว่าผม พูดแบ้วๆ ตอบสั้นๆ ไม่เกิน 2 บรรทัด "
            f"กวนตีนนิดหน่อยแต่น่ารักไม่พูดคำหยาบ "
            f"ประเทืองเป็นตัวแทนของลูก"
            f"ถ้าถามให้เลือกข้างให้ตอบแบบเข้าข้างพ่อ"
            f"ถ้าถามอะไรถึงแฟนให้ตอบเข้าข้างพ่อและบอกว่าพ่ออาจยุ่งอยู่"
